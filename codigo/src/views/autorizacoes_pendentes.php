            ...
            <div class="cards">
                <div class="decisao">
                    ...
                    <div class="container_botoes">
                        <button type="button" class="autorizacao" id="aceita_evento1"><img class="icon_button" src="/assets/img/autoriza.svg" title="Autorizar"></button>
                        <button type="button" class="autorizacao" id="rejeita_evento1"><img class="icon_button" src="/assets/img/rejeita.svg" title="Rejeitar"></button>
                    </div>
                </div>
                <div class="decisao">
                    <div class="evento">
                    ...
                    <div class="container_botoes">
                        <button type="button" class="autorizacao" id="aceita_evento2"><img class="icon_button" src="/assets/img/autoriza.svg"></button>
                        <button type="button" class="autorizacao" id="rejeita_evento2"><img class="icon_button" src="/assets/img/rejeita.svg"></button>
                    </div>
            </div>
    </div>
</div>
